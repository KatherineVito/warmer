...
use Drupal\warmer_cdn\SitemapParserFactory;
...
final class SitemapWarmer extends WarmerPluginBase {
  ...
  public function loadMultiple(array $ids = []) {
    return $this->cdnWarmer()->loadMultiple($ids)->accessCheck(TRUE);
  }
